...
# 参数
TP=4
# Split dense parameters across more pipeline stages to keep each DP
# gradient collective below the ~518 MiB size that destabilizes HCCL/IB.
PP=16
EP=16
CP=1
ETP=1 
...
PYTORCH_PROFILER_DIR="${BASE_PATH}/profiler/qwen-base"
if [ "${NODE_RANK}" = "0" ]; then
