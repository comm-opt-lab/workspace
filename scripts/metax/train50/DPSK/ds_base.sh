...
PREFIX="full-dpskv3-baseline-speedup"
...
# profilerlogpath="/private/accept/profilerlog/ds-base"
...
run_cmd="torchrun $DISTRIBUTED_ARGS $MEGATRON_PATH/pretrain_gpt.py ${megatron_options} ${PYTORCH_PROFILER_ARGS} ${moe_options} ${RECOMPUTE_ARGS} ${PROFILE_ARGS} ${TEST_ARGS}"
